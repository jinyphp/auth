...
/**
 * 관리자 - 사용자 리뷰 수정 폼 컨트롤러
 *
 * 진입 경로:
 * Route::get('/admin/auth/user/reviews/{id}/edit') → EditController::__invoke()
 */
class EditController extends Controller
{
    ...
    protected function loadConfig()
    {
        ...
        $this->config = [
            'view' => $editConfig['view'] ?? 'jiny-auth::admin.user-review.edit',
            'title' => $editConfig['title'] ?? '리뷰 수정',
            'subtitle' => $editConfig['subtitle'] ?? '리뷰 정보 수정',
        ];
    }
