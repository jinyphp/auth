<?php
namespace Jiny\Auth\Http\Controllers\Home;
...
class HomeUserTerms extends AdminController
{
    public function __construct()
    {
        ...
        $this->viewLayout = inSlotView('home.terms', 'jiny-auth::home.terms.layout');

        $this->actions['view']['list'] = "jiny-auth::admin.terms.list";
        $this->actions['view']['form'] = "jiny-auth::admin.terms.form";
