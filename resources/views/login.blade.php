            ...
            <main id="page-content" class="flex flex-auto flex-col max-w-full">
                <div class="min-h-screen flex items-center justify-center relative overflow-hidden max-w-10xl mx-auto p-4 lg:p-8 w-full">
                    ...
                    <div class="mb-8 text-center">
                        ...
                        서비스를 이용하기 위해서는 먼저 로그인을 하셔야 합니다.
                        </p>
                    </div>
                    <!-- END Header -->
                    ...
                    <div class="flex flex-col rounded shadow-sm bg-white overflow-hidden">
                        ...
                        <div class="sm:p-5 lg:px-10 lg:py-8">
                            ...
                            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <input class="block border border-gray-200 rounded px-5 py-3 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" type="password" id="password" name="password" placeholder="Enter your password" required >
                                </div>
                                <div>
                            ...
                            @if(count($provider)>0)
                                ...
                                <h3 class="flex items-center my-8">
                                    ...
                                    <span class="text-느 font-medium mx-3">소셜 로그인</span>
                                    <span aria-hidden="true" class="grow bg-gray-200 rounded h-0.5"></span>
                                </h3>
                        ...
                        아직 회원이 아니세요?
                        <a class="font-medium text-indigo-600 hover:text-indigo-400" href="/register">회원가입</a>
                        </div>
                    </div>
                    <!-- END Sign In Form -->
