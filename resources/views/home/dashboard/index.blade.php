                ...
                <div class="d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="d-flex gap-2">
                        @php
                            ...
                            $hasPartnerPackage = class_exists('\Jiny\Partner\Models\PartnerUser') || class_exists('\Jiny\Partner\Models\PartnerApplication');
                            ...
                            if ($hasPartnerPackage && $user && $user->uuid) {
                                try {
                                    ...
                                    if (!$partnerUser) {
                                        $partnerApplication = \Jiny\Partner\Models\PartnerApplication::where('user_uuid', $user->uuid)->latest()->first();
                                    }
                                } catch (\Exception $e) {
                                    // 테이블이 없거나 오류 발생시 무시
                                }
                        ...
                        @if($hasPartnerPackage)
                            ...
                            @elseif($partnerApplication)
                                ...
                                <a href="{{ route('home.partner.regist.status', $partnerApplication->id) }}" class="btn btn-warning d-flex flex-row gap-2">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
