...
<head>
    ...
    <title>@yield('title', 'Dashboard') - Admin Sidebar Layout | Jiny</title>
    @stack('styles')
</head>
                ...
                <ul class="navbar-nav flex-column" id="sideNavbar">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="navCourses" class="collapse " data-bs-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.courses.overview') }}">All
                                        Courses</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="{{ route('admin.courses.categories') }}">Courses Category</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="{{ route('admin.courses.categories.single', 1) }}">Category
                                        Single</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="navProfile" class="collapse " data-bs-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="{{ route('admin.users.instructors') }}">Instructor</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="{{ route('admin.users.students') }}">Students</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="navCMS" class="collapse " data-bs-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="{{ route('admin.cms.overview') }}">Overview</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.cms.posts') }}">All
                                        Post</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.cms.posts.new') }}">New
                                        Post</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="{{ route('admin.cms.categories') }}">Category</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="navProject" class="collapse " data-bs-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.projects.grid') }}">Grid</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div id="navprojectSingle" class="collapse " data-bs-parent="#navProject">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link "
                                                    href="{{ route('admin.projects.overview', 1) }}">Overview</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link "
                                                    href="{{ route('admin.projects.tasks', 1) }}">Task</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link "
                                                    href="{{ route('admin.projects.budget', 1) }}">Budget</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link "
                                                    href="{{ route('admin.projects.team', 1) }}">Team</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link "
                                                    href="{{ route('admin.projects.files', 1) }}">Files</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link "
                                                    href="{{ route('admin.projects.summary', 1) }}">Summary</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.projects.new') }}">Create
                                        Project</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link  collapsed " href="#" data-bs-toggle="collapse"
                            data-bs-target="#navJobManagement" aria-expanded="false"
                            aria-controls="navJobManagement">
                            <i class="nav-icon fe fe-briefcase me-2"></i>
                            Job Management
                        </a>
                        <div id="navJobManagement" class="collapse " data-bs-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.job.dashboard') }}">Dashboard</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.job.listings') }}">Job Listings</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.job.listings.create') }}">Create Job</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.job.companies') }}">Companies</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.job.talent') }}">Talent Pool</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.job.applications') }}">Applications</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                            ...
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.auth.users.index') }}">
                                        <i class="fe fe-users me-2"></i>사용자 관리
                                    </a>
                                </li>
                                <!-- 계정 보안 -->
                                <li class="nav-item">
                                    <a class="nav-link  collapsed " href="#" data-bs-toggle="collapse"
                                        data-bs-target="#navAccountSecurity" aria-expanded="false"
                                        aria-controls="navAccountSecurity">
                                        <i class="fe fe-shield me-2"></i>계정 보안
                                    </a>
                                    <div id="navAccountSecurity" class="collapse " data-bs-parent="#navAuthentication">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.lockouts.index') }}">계정 잠금</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.deletions.index') }}">탈퇴 신청</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.user.blacklist.index') }}">블랙리스트</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link  collapsed " href="#" data-bs-toggle="collapse"
                                        data-bs-target="#navUserSettings" aria-expanded="false"
                                        aria-controls="navUserSettings">
                                        <i class="fe fe-settings me-2"></i>사용자 설정
                                    </a>
                                    <div id="navUserSettings" class="collapse " data-bs-parent="#navAuthentication">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.user.types.index') }}">사용자 타입</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.user.grades.index') }}">사용자 등급</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.user.reserved.index') }}">예약 키워드</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link  collapsed " href="#" data-bs-toggle="collapse"
                                        data-bs-target="#navSocialOAuth" aria-expanded="false"
                                        aria-controls="navSocialOAuth">
                                        <i class="fe fe-share-2 me-2"></i>소셜 & OAuth
                                    </a>
                                    <div id="navSocialOAuth" class="collapse " data-bs-parent="#navAuthentication">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.user.social.index') }}">소셜 계정</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.oauth.providers.index') }}">OAuth 프로바이더</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link  collapsed " href="#" data-bs-toggle="collapse"
                                        data-bs-target="#navAuthSystem" aria-expanded="false"
                                        aria-controls="navAuthSystem">
                                        <i class="fe fe-database me-2"></i>시스템 관리
                                    </a>
                                    <div id="navAuthSystem" class="collapse " data-bs-parent="#navAuthentication">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.terms.index') }}">이용약관</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.user.logs.index') }}">사용자 로그</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.user.messages.index') }}">사용자 메시지</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.user.reviews.index') }}">사용자 리뷰</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link  collapsed " href="#" data-bs-toggle="collapse"
                                        data-bs-target="#navEmoney" aria-expanded="false"
                                        aria-controls="navEmoney">
                                        <i class="fe fe-dollar-sign me-2"></i>이머니 & 포인트
                                    </a>
                                    <div id="navEmoney" class="collapse " data-bs-parent="#navAuthentication">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.emoney.index') }}">지갑 관리</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.emoney.deposits') }}">입금 내역</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.emoney.withdrawals') }}">출금 내역</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link  collapsed " href="#" data-bs-toggle="collapse"
                                        data-bs-target="#navUserData" aria-expanded="false"
                                        aria-controls="navUserData">
                                        <i class="fe fe-globe me-2"></i>데이터 관리
                                    </a>
                                    <div id="navUserData" class="collapse " data-bs-parent="#navAuthentication">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.user.countries.index') }}">국가</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.user.languages.index') }}">언어</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.user.addresses.index') }}">주소</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="{{ route('admin.auth.user.phones.index') }}">전화번호</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                    ...
                    <!-- Nav item -->
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('admin.apps.chat') }}">
                    ...
                    <!-- Nav item -->
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('admin.apps.task-kanban') }}">
                            <span>
                    ...
                    <!-- Nav item -->
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('admin.apps.mail.index') }}">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <!-- Nav item -->
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('admin.apps.calendar') }}">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <li class="nav-item">
                        ...
                        <div id="navTables" class="collapse " data-bs-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.components.tables.basic') }}">Basic</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.components.tables.datatables') }}">Data
                                        Tables</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="navSiteSetting" class="collapse " data-bs-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="{{ route('admin.settings.general') }}">General</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="{{ route('admin.settings.google') }}">Google</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="{{ route('admin.settings.social') }}">Social</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="{{ route('admin.settings.social-login') }}">Social Login</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link "
                                        href="{{ route('admin.settings.payment') }}">Payment</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.settings.smtp') }}">SMPT</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <!-- Nav item -->
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('docs.changelog') }}">
