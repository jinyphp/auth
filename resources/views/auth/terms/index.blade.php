            ...
            <div class="card shadow">
                ...
                <div class="card-body p-6">
                    ...
                    <form action="{{ route('register.terms.accept') }}" method="POST">
                        ...
                        <div class="mb-4">
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input term-checkbox mandatory-term"
                                                   id="terms_{{ $term->id }}" name="terms[]" value="{{ $term->id }}" required>
                            ...
                            @if($optionalTerms && $optionalTerms->count() > 0)
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input term-checkbox optional-term"
                                                   id="terms_{{ $term->id }}" name="terms[]" value="{{ $term->id }}">
                                            <label class="form-check-label" for="terms_{{ $term->id }}">
                                                <div class="d-flex align-items-start">
                        ...
                        <div class="mb-4">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="terms_default" name="terms[]" value="0" required>
