...
@section('title', '예약 키워드 생성')
@section('content')
<div class="container-fluid p-6">
    <div class="row"><div class="col-12"><div class="border-bottom pb-3 mb-3"><h1 class="h2 fw-bold">예약 키워드 생성</h1></div></div></div>
    <div class="row"><div class="col-lg-8">
            <div class="card"><div class="card-body">
                    <form action="{{ route('admin.auth.user.reserved.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('admin.auth.user.reserved.index') }}" class="btn btn-outline-secondary">취소</a>
