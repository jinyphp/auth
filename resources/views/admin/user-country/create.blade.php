    ...
    <section class="container-fluid p-4">
            ...
            <div class="col-lg-12 col-md-12 col-12">
                ...
                <div class="border-bottom pb-3 mb-3">
                    <div class="d-flex flex-column gap-1">
                        <h1 class="mb-0 h2 fw-bold">새 국가 추가</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">새 국가 추가</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.auth.user.countries.store') }}">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          name="description"
                                          rows="3"
                                          placeholder="국가에 대한 추가 설명">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">국가 생성</button>
                            </div>
                        </form>
                    </div>
                </div>
