    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="mb-0">이용약관 생성</h2>
                    <p class="text-muted mb-0">새로운 이용약관을 추가합니다</p>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.auth.terms.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('pos') is-invalid @enderror"
                                       id="pos" name="pos" value="{{ old('pos', 1) }}">
                                @error('pos')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="required" name="required"
                                       value="1" {{ old('required', true) ? 'checked' : '' }}>
