...
@section('title', '관리자 대시보드 | Geeks - Bootstrap 5 Admin Dashboard Template')
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <div
                    ...
                    <div>
                        <h1 class="mb-0 h2 fw-bold">관리자 대시보드</h1>
                    </div>
                    <div class="d-flex gap-3">
                        <div class="input-group">
                            <input class="form-control flatpickr" type="text" placeholder="날짜 선택"
                ...
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column gap-3">
                        <div class="d-flex align-items-center justify-content-between lh-1">
                            <div>
                                <span class="fs-6 text-uppercase fw-semibold ls-md">판매</span>
                            </div>
                            <div>
                        ...
                        <div class="d-flex flex-column gap-1">
                            ...
                            <div class="d-flex flex-row gap-2">
                                ...
                                <span class="fw-medium">판매 수</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column gap-3">
                        <div class="d-flex align-items-center justify-content-between lh-1">
                            <div>
                                <span class="fs-6 text-uppercase fw-semibold ls-md">강좌</span>
                            </div>
                            <div>
                        ...
                        <div class="d-flex flex-column gap-1">
                            ...
                            <div class="d-flex flex-row gap-2">
                                ...
                                <span class="fw-medium">대기 중인 수</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column gap-3">
                        <div class="d-flex align-items-center justify-content-between lh-1">
                            <div>
                                <span class="fs-6 text-uppercase fw-semibold ls-md">학생</span>
                            </div>
                            <div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column gap-3">
                        <div class="d-flex align-items-center justify-content-between lh-1">
                            <div>
                                <span class="fs-6 text-uppercase fw-semibold ls-md">강사</span>
                            </div>
                            <div>
                        ...
                        <div class="d-flex flex-column gap-1">
                            ...
                            <div class="d-flex flex-row gap-1">
                                ...
                                <span class="ms-1 fw-medium">강사</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-12 col-md-12 col-12">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between card-header-height">
                        <h4 class="mb-0">인기 강사</h4>
                        <a href="#" class="btn btn-outline-secondary btn-sm">전체 보기</a>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <!-- List group -->
                                ...
                                <div class="row flex-column flex-md-row gap-3 gap-md-0">
                                    ...
                                    <div class="col-md-8 col-10">
                                        <div class="d-flex flex-column gap-2">
                                            <a href="#">
                                                <h5 class="text-primary-hover mb-0">Revolutionize how you build the web...
                                                </h5>
                                            </a>
                            ...
                            <li class="list-group-item px-0">
                                <div class="row flex-column flex-md-row gap-3 gap-md-0">
                                    ...
                                    <div class="col-md-8 col-10">
                                        <div class="d-flex flex-column gap-2">
                                            <a href="#">
                                                <h5 class="text-primary-hover mb-0">Guide to Static Sites with Gatsby.js
                                                </h5>
                                            </a>
                                            <div class="d-flex align-items-center gap-2">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row flex-column flex-md-row gap-3 gap-md-0">
                                    ...
                                    <div class="col-md-8 col-10">
                                        <div class="d-flex flex-column gap-2">
                                            <a href="#">
                                                <h5 class="text-primary-hover mb-0">Online WordPress Courses Become an
                                                    Expert Today‎</h5>
                                            </a>
                                            <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="col ms-n2">
                                        <div class="d-flex flex-column gap-1">
                                            <div>
                                                ...
                                                <p class="mb-0">"React 애플리케이션 구축 튜토리얼" 강좌를 구매했습니다</p>
                                            </div>
                                            <div>
                                                <span class="fs-6">2분 전</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col ms-n2">
                                        <div class="d-flex flex-column gap-1">
                                            <div>
                                                ...
                                                <p class="mb-0">"Bootstrap 튜토리얼"에 댓글: "안녕하세요, 저는 irene...</p>
                                            </div>
                                            <div>
                                                <span class="fs-6">1시간 전</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col ms-n2">
                                        <div class="d-flex flex-column gap-1">
                                            <div>
                                                ...
                                                <p class="mb-0">소셜 미디어에 글을 공유했습니다..</p>
                                            </div>
                                            <div>
                                                <span class="fs-6">2개월 전</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
